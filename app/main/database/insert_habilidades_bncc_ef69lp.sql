-- Script para inserir habilidades BNCC EF69LP (6º ao 9º ano - Língua Portuguesa)
-- Este script verifica se a tabela existe, cria se necessário, e insere apenas os registros que não existem
-- Data: 2025-12-15

-- ============================================
-- PARTE 1: Criar tabela habilidades_bncc se não existir
-- ============================================
...
CREATE TABLE IF NOT EXISTS `habilidades_bncc` (
  ...
  `nivel_ensino` varchar(50) DEFAULT NULL COMMENT 'ENSINO_FUNDAMENTAL_ANOS_INICIAIS, ENSINO_FUNDAMENTAL_ANOS_FINAIS, etc',
  `disciplina_id` bigint(20) DEFAULT NULL COMMENT 'ID da disciplina (1 = Língua Portuguesa)',
  `serie` varchar(20) DEFAULT NULL COMMENT '6º, 7º, 8º, 9º ano',
  `ativo` tinyint(1) DEFAULT 1,
  `criado_em` timestamp NOT NULL DEFAULT current_timestamp(),
  `atualizado_em` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
  UNIQUE KEY `codigo` (`codigo`),
  KEY `idx_nivel_ensino` (`nivel_ensino`),
  KEY `idx_disciplina_id` (`disciplina_id`),
  KEY `idx_ativo` (`ativo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- ============================================
-- PARTE 2: Inserir habilidades EF69LP01 até EF69LP55
-- Apenas insere se o código não existir
-- ============================================

-- EF69LP01
INSERT INTO `habilidades_bncc` (`codigo`, `descricao`, `nivel_ensino`, `disciplina_id`, `serie`)
SELECT 
    'EF69LP01',
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP01');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP02');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP03');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP04');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP05');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP06');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP07');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP08');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP09');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP10');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP11');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP12');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP13');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP14');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP15');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP16');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP17');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP18');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP19');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP20');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP21');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP22');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP23');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP24');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP25');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP26');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP27');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP28');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP29');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP30');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP31');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP32');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP33');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP34');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP35');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP36');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP37');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP38');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP39');

-- EF69LP40
INSERT INTO `habilidades_bncc` (`codigo`, `descricao`, `nivel_ensino`, `disciplina_id`, `serie`)
SELECT 
    'EF69LP40',
    'Analisar, em gravações de seminários, conferências rápidas, trechos de palestras, dentre outros, a construção composicional dos gêneros de apresentação – abertura/saudação, introdução ao tema, apresentação do plano de exposição, desenvolvimento dos conteúdos, por meio do encadeamento de temas e subtemas (coesão temática), síntese final e/ou conclusão, encerramento –, os elementos paralinguísticos (tais como: tom e volume da voz, pausas e hesitações – que, em geral, devem ser minimizadas –, modulação de voz e entonação, ritmo, respiração etc.) e cinésicos (tais como: postura corporal, movimentos e gestualidade significativa, expressão facial, contato de olho com plateia etc.), para melhor performar apresentações orais no campo da divulgação do conhecimento.',
    'ENSINO_FUNDAMENTAL_ANOS_FINAIS',
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP40');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP41');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP42');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP43');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP44');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP45');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP46');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP47');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP48');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP49');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP50');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP51');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP52');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP53');
...
SELECT 
    ...
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP54');

-- EF69LP55
INSERT INTO `habilidades_bncc` (`codigo`, `descricao`, `nivel_ensino`, `disciplina_id`, `serie`)
SELECT 
    'EF69LP55',
    'Reconhecer as variedades da língua falada, o conceito de norma-padrão e adequar a produção oral a diferentes contextos comunicativos, considerando as características do gênero, o público-alvo, o objetivo comunicativo e o suporte, demonstrando domínio das variedades linguísticas adequadas a cada situação de uso.',
    'ENSINO_FUNDAMENTAL_ANOS_FINAIS',
    1,
    '6º ao 9º'
WHERE NOT EXISTS (SELECT 1 FROM `habilidades_bncc` WHERE `codigo` = 'EF69LP55');
...
SELECT 
    COUNT(*) as total_habilidades_ef69lp,
    'EF69LP01 até EF69LP55' as descricao
FROM `habilidades_bncc`
WHERE `codigo` LIKE 'EF69LP%';

-- Listar todos os códigos inseridos
SELECT `codigo`, LEFT(`descricao`, 100) as descricao_resumida
FROM `habilidades_bncc`
WHERE `codigo` LIKE 'EF69LP%'
ORDER BY `codigo`;
