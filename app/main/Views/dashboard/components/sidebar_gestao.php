...
<aside id="sidebar" class="fixed left-0 top-0 h-full w-64 bg-white shadow-lg sidebar-transition z-50 lg:translate-x-0 sidebar-mobile flex flex-col">
    ...
    <nav class="p-4 overflow-y-auto flex-1" style="max-height: calc(100vh - 200px);">
        <ul class="space-y-2">
            ...
            <li>
                <a href="gestao_escolar.php" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 <?= ($currentPage === 'gestao_escolar.php' && (!isset($_GET['tab']) || $_GET['tab'] !== 'relatorios')) ? 'bg-primary-green text-white' : 'hover:bg-gray-100' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="consumo_merenda.php" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 <?= $currentPage === 'consumo_merenda.php' ? 'bg-primary-green text-white' : 'hover:bg-gray-100' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="cardapios_merenda.php" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 <?= $currentPage === 'cardapios_merenda.php' ? 'bg-primary-green text-white' : 'hover:bg-gray-100' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="gestao_escolar.php?tab=relatorios" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 <?= (basename($_SERVER['PHP_SELF']) === 'gestao_escolar.php' && isset($_GET['tab']) && $_GET['tab'] === 'relatorios') ? 'bg-primary-green text-white' : 'hover:bg-gray-100' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
