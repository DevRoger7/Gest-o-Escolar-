<?php
// Componente reutilizável de sidebar para responsável
...
<aside id="sidebar" class="fixed left-0 top-0 h-full w-64 bg-white shadow-lg sidebar-transition z-50 lg:translate-x-0 sidebar-mobile">
    ...
    <div class="p-4 border-b border-gray-200">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <p class="text-sm font-medium text-gray-800"><?= $_SESSION['nome'] ?? 'Responsável' ?></p>
    ...
    <nav class="p-4">
        <ul class="space-y-2">
            ...
            <li>
                <a href="responsavel_notas.php" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 <?= basename($_SERVER['PHP_SELF']) === 'responsavel_notas.php' ? 'active' : '' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="responsavel_frequencia.php" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 <?= basename($_SERVER['PHP_SELF']) === 'responsavel_frequencia.php' ? 'active' : '' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="responsavel_observacoes.php" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 <?= basename($_SERVER['PHP_SELF']) === 'responsavel_observacoes.php' ? 'active' : '' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
