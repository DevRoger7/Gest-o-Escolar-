...
<aside id="sidebar" class="fixed left-0 top-0 h-full w-64 bg-white shadow-lg sidebar-transition z-50 lg:translate-x-0 sidebar-mobile">
    ...
    <nav class="p-4 overflow-y-auto sidebar-nav" style="max-height: calc(100vh - 200px); scroll-behavior: smooth; padding-bottom: 80px;">
        <ul class="space-y-2">
            ...
            <li>
                <a href="transferencia_alunos.php" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 <?= $currentPage === 'transferencia_alunos.php' ? 'active' : '' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path>
                    </svg>
                    <span>Transferência de Alunos</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="gestao_programas.php" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 <?= $currentPage === 'gestao_programas.php' ? 'active' : '' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                    </svg>
            ...
            <!-- Transporte -->
            <li class="pt-4">
                <p class="px-4 text-xs font-semibold text-gray-500 uppercase tracking-wider">Transporte</p>
            </li>
            <li>
                <a href="gestao_usuarios_transporte.php" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 <?= $currentPage === 'gestao_usuarios_transporte.php' ? 'active' : '' ?>">
                    ...
                    <span>Usuários de Transporte</span>
                </a>
            </li>
            <li>
            ...
            <li>
                <a href="gestao_localidades_distrito.php" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 <?= $currentPage === 'gestao_localidades_distrito.php' ? 'active' : '' ?>">
                    ...
                    <span>Localidades e Distritos</span>
                </a>
            </li>
            ...
            <li>
                <a href="acoes_sistema_adm.php" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 <?= $currentPage === 'acoes_sistema_adm.php' ? 'active' : '' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="limpar_banco_adm.php" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg text-red-600 hover:bg-red-50 <?= $currentPage === 'limpar_banco_adm.php' ? 'active' : '' ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
