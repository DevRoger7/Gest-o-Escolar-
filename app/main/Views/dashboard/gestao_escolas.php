...
<body class="bg-gray-50 font-sans">
    ...
    <div id="userProfileModal" class="fixed inset-0 bg-white dark:bg-gray-900 z-50 hidden">
        ...
        <div class="h-[calc(100vh-120px)] overflow-y-auto bg-white dark:bg-gray-900">
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                                <div class="flex items-start space-x-6">
                                    ...
                                    <div class="flex-1">
                                        <h2 class="text-2xl font-bold text-gray-900 mb-2"><?php echo $_SESSION['nome']; ?></h2>
                                        ...
                                        <div class="grid grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                <p class="text-gray-900 font-medium"><?php echo $_SESSION['email']; ?></p>
                                            </div>
                                            <div>
                                                <p class="text-sm text-gray-600 mb-1">Último Acesso</p>
                                                <p class="text-gray-900 font-medium">Agora</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-4">
                                        <div>
                                            ...
                                            <p class="text-gray-900 font-medium mt-1"><?php echo $_SESSION['nome']; ?></p>
                                        </div>
                                        <div>
                                            <label class="text-sm font-medium text-gray-600">CPF</label>
                                            <p class="text-gray-900 font-medium mt-1"><?php echo $_SESSION['cpf']; ?></p>
                                        </div>
                                    </div>
                                    <div class="space-y-4">
                                        <div>
                                            <label class="text-sm font-medium text-gray-600">Email</label>
                                            <p class="text-gray-900 font-medium mt-1"><?php echo $_SESSION['email']; ?></p>
                                        </div>
                                        <div>
                                            <label class="text-sm font-medium text-gray-600">Telefone</label>
                                            <p class="text-gray-900 font-medium mt-1"><?php echo $_SESSION['telefone']; ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <!-- Settings Tab -->
            <div id="content-settings" class="profile-content hidden p-4 md:p-8">
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 md:p-8">
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white mb-6">Configurações de Acessibilidade</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                        <div>
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Tema Visual</h3>
                            <div class="grid grid-cols-2 gap-3">
                                <button id="theme-light" onclick="setTheme('light')" class="flex items-center justify-center space-x-2 px-4 py-3 text-sm border-2 border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"></path>
                                    </svg>
                                    <span class="font-medium text-gray-900 dark:text-white">Claro</span>
                                </button>
                                <button id="theme-dark" onclick="setTheme('dark')" class="flex items-center justify-center space-x-2 px-4 py-3 text-sm border-2 border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div>
                            <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">Tamanho da Fonte</h3>
                            <div class="grid grid-cols-3 gap-3">
                                <button onclick="setFontSize('normal')" id="font-normal" class="flex items-center justify-center px-3 py-3 text-sm border-2 border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                                    <span class="text-sm font-bold text-gray-900 dark:text-white">A</span>
                                </button>
                                <button onclick="setFontSize('large')" id="font-large" class="flex items-center justify-center px-3 py-3 text-sm border-2 border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                                    <span class="text-base font-bold text-gray-900 dark:text-white">A</span>
                                </button>
                                <button onclick="setFontSize('larger')" id="font-larger" class="flex items-center justify-center px-3 py-3 text-sm border-2 border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition-all duration-200">
                                    <span class="text-lg font-bold text-gray-900 dark:text-white">A</span>
                                </button>
                            </div>
                        </div>
                        </div>
