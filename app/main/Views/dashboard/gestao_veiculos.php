    ...
    <div id="modalCriarVeiculo" class="fixed inset-0 bg-black bg-opacity-50 hidden z-50 flex items-center justify-center">
        <div class="bg-white rounded-lg max-w-2xl w-full mx-4 max-h-[90vh] flex flex-col">
            ...
            <form id="formCriarVeiculo" onsubmit="criarVeiculo(event)" class="flex flex-col flex-1 min-h-0">
                ...
                <div class="p-6 border-t border-gray-200 flex justify-end space-x-3 flex-shrink-0 bg-white relative z-10" style="position: relative; z-index: 10;">
                    <button type="button" onclick="fecharModalCriarVeiculo()" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition-colors" style="position: relative; z-index: 11;">
                        Cancelar
                    </button>
                    <button type="submit" class="px-4 py-2 text-white rounded-lg hover:bg-green-700 transition-colors font-medium shadow-sm" style="background-color: #16a34a; position: relative; z-index: 11; min-width: 100px;">
                        Cadastrar
                    </button>
                </div>
            </form>
