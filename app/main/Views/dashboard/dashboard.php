...
<head>
    ...
    <style>
        ...
        /* Forçar todos os elementos text-gray-900 para branco no tema escuro */
        [data-theme="dark"] .text-gray-900 {
            color: #ffffff !important;
        }
        
        /* Garantir que todos os títulos sejam brancos */
        [data-theme="dark"] h1,
        [data-theme="dark"] h2,
        [data-theme="dark"] h3,
        [data-theme="dark"] h4,
        ...
        /* Forçar cor específica rgb(17 24 39) para branco no tema escuro */
        ...
        /* Regra mais agressiva para garantir que todos os elementos escuros sejam brancos */
        [data-theme="dark"] * {
            color: inherit;
        }
        ...
        /* Exceções para elementos que devem manter suas cores específicas */
        [data-theme="dark"] .text-green-600,
        ...
        /* Regra final para garantir que TODOS os elementos escuros sejam brancos */
        [data-theme="dark"] * {
            color: #ffffff !important;
        }
        ...
        /* Forçar cor específica rgb(17 24 39) para branco no tema escuro - versão mais agressiva */
        [data-theme="dark"] *[style*="color: rgb(17, 24, 39)"],
        [data-theme="dark"] *[style*="color:rgb(17, 24, 39)"],
        [data-theme="dark"] *[style*="color: rgb(17 24 39)"],
        [data-theme="dark"] *[style*="color:rgb(17 24 39)"],
