...
<body class="bg-gray-50 font-sans">
    ...
    <aside id="sidebar" class="fixed left-0 top-0 h-full w-64 bg-white shadow-lg sidebar-transition z-50 lg:translate-x-0 sidebar-mobile">
        ...
        <nav class="p-4">
            <ul class="space-y-2">
                ...
                <li id="transporte-menu">
                    <a href="gestao_transporte_adm.php" class="menu-item flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <main class="content-transition ml-0 lg:ml-64 min-h-screen">
            ...
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16 header-content">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <!-- User Profile Button -->
                        <a href="profile.php?section=profile" class="p-2 text-gray-600 bg-gray-100 rounded-full hover:bg-gray-200 transition-colors cursor-pointer" title="Meu Perfil">
        ...
        <div class="p-4 sm:p-6 lg:p-8">
            ...
            function renderUserInterface() {
                ...
                switch(strtolower($userType)) {
                    ...
                    case 'adm_merenda':
                        ...
                        break;
                    case 'adm_transporte':
                        renderAdmTransporteInterface();
                        break;
                    case 'transporte_aluno':
                        renderTransporteAlunoInterface();
                        break;
                    case 'gestao':
            ...
            // === INTERFACE DO ADMINISTRADOR DE TRANSPORTE ===
            function renderAdmTransporteInterface() {
