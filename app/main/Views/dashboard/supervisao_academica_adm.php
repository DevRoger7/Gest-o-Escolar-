...
<head>
    ...
    <title>Supervisão Acadêmica - SIGEA</title>
    ...
    <main class="content-transition ml-0 lg:ml-64 min-h-screen">
            ...
            <div class="px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="flex-1 text-center lg:text-left">
                        <h1 class="text-xl font-semibold text-gray-800">Supervisão Acadêmica</h1>
                    </div>
        ...
        <div class="p-8">
            <div class="max-w-7xl mx-auto">
                <div class="mb-6">
                    <h2 class="text-2xl font-bold text-gray-900">Supervisão do Módulo Acadêmico</h2>
                    <p class="text-gray-600 mt-1">Acompanhe e supervisione todas as atividades acadêmicas do sistema</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <a href="gestao_escolar.php" class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                        <div class="flex items-center space-x-4">
                            <div class="p-3 bg-blue-100 rounded-xl">
                                <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900">Gestão Escolar</h3>
                                <p class="text-sm text-gray-600">Gerenciar turmas e atribuições</p>
                            </div>
                        </div>
                    </a>
                    
                    <a href="gestao_alunos_adm.php" class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                        <div class="flex items-center space-x-4">
                            <div class="p-3 bg-green-100 rounded-xl">
                                <svg class="w-6 h-6 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900">Gestão de Alunos</h3>
                                <p class="text-sm text-gray-600">Cadastrar e gerenciar alunos</p>
                            </div>
                        </div>
                    </a>
                    
                    <a href="gestao_professores_adm.php" class="bg-white rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                        <div class="flex items-center space-x-4">
                            <div class="p-3 bg-purple-100 rounded-xl">
                                <svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900">Gestão de Professores</h3>
                                <p class="text-sm text-gray-600">Cadastrar e gerenciar professores</p>
                            </div>
                        </div>
                    </a>
                </div>
