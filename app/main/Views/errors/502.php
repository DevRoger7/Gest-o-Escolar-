...
<head>
    ...
    <title>Bad Gateway - <?= getNomeSistemaCurto() ?></title>
                ...
                <div class="grid grid-cols-1 md:grid-cols-[1fr,1px,1fr] gap-8 md:gap-12 items-center">
                    ...
                    <div class="text-center md:text-left">
                        ...
                        <p class="text-sm text-gray-500 leading-relaxed mb-8 max-w-xs">
                            O servidor recebeu uma resposta inválida de um servidor upstream. Isso geralmente indica um problema temporário de comunicação.
                        </p>
