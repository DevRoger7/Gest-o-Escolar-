...
<head>
    ...
    <title>Gateway Timeout - <?= getNomeSistemaCurto() ?></title>
                ...
                <div class="grid grid-cols-1 md:grid-cols-[1fr,1px,1fr] gap-8 md:gap-12 items-center">
                    ...
                    <div class="text-center md:text-left">
                        ...
                        <p class="text-sm text-gray-500 leading-relaxed mb-8 max-w-xs">
                            O servidor não recebeu uma resposta a tempo de um servidor upstream. A requisição expirou antes de ser concluída.
                        </p>
