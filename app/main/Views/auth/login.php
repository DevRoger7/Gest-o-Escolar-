...
<head>
    ...
    <title>Login - SIGAE | Sistema Integrado de Gestão Escolar</title>
...
<body class="min-h-screen bg-white md:gradient-mesh">
    ...
    <div class="md:hidden w-full max-w-md mx-auto px-4 py-8">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-600 text-sm font-medium mb-1">Sistema Integrado de Gestão Escolar</p>
        ...
        <!-- Mensagem de erro via GET parameter -->
        <div id="getErrorMessage" class="error-message" style="display: none;">
            <div class="flex items-center">
                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
    ...
    <div class="hidden md:flex min-h-screen">
        <div class="flex-1 relative bg-cover bg-center" style="background-image: url('https://i.postimg.cc/dtn35crz/maranguape-bg.jpg');">
            ...
            <div class="absolute inset-0 flex items-center justify-center">
                <div class="text-center text-white p-8">
                    ...
                    <p class="text-xl text-white/90"> Sistema Integrado de Gestão Escolar</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex-1 flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                ...
                <!-- Mensagem de erro via GET parameter Desktop -->
                <div id="getErrorMessageDesktop" class="error-message" style="display: none;">
                    <div class="flex items-center">
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                        </svg>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            // Verificar parâmetro de erro na URL (similar ao login.php)
            const urlParams = new URLSearchParams(window.location.search);
            const erro = urlParams.get('erro');
            
            if (erro === '1') {
                // Mostrar mensagem de erro para mobile
                const getErrorMessage = document.getElementById('getErrorMessage');
                if (getErrorMessage) {
                    getErrorMessage.style.display = 'block';
                }
                
                // Mostrar mensagem de erro para desktop
                const getErrorMessageDesktop = document.getElementById('getErrorMessageDesktop');
                if (getErrorMessageDesktop) {
                    getErrorMessageDesktop.style.display = 'block';
                }
            }
        });
    </script>
