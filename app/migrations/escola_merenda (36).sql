...
--
-- Host: 127.0.0.1
-- Tempo de geração: 16/12/2025 às 19:26
...
CREATE TABLE `escola` (
  ...
  `localidade_escola` varchar(255) DEFAULT NULL,
  ...
  `nivel_ensino` set('EDUCACAO_INFANTIL','ENSINO_FUNDAMENTAL','ENSINO_MEDIO') DEFAULT 'ENSINO_FUNDAMENTAL',
...
(3, 3, 'francisco', '$2y$10$RqVIvLDU2B3aMH8D5DCUeubFZ0dVMgvfNgzbhCqWr6REia5O/69gy', 'ADM', 1, 0, NULL, NULL, 0, NULL, '2025-12-16 15:39:29', '2025-12-16 18:26:10', '2025-09-22 19:42:40', '2025-12-16 18:26:10', NULL);
